                        ...
                        <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="title" name="title" value="{{$obj?$obj->title:''}}" class="form-control form-control-solid" placeholder="{{__("art.enter").' '.__("art.title")}}" autocomplete="off">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="subtitle" name="subtitle" value="{{$obj?$obj->subtitle:''}}" class="form-control form-control-solid" placeholder="{{__("art.enter").' '.__("art.subtitle")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="date" name="date" value="{{$obj?$obj->date:''}}" class="form-control form-control-solid date" placeholder="{{__("art.enter").' '.__("art.date")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                ...
                                <div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <select id="catid" name="catid" class="form-control">
                                            ...
                                            @foreach ($cats as $cat)
                                                <option value="{{$cat->id}}" {{$obj->catid == $cat->id?'selected':''}}> {{ $cat->title }}</option>
                                            @endforeach
                                        </select>
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
                                ...
                                <div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <img style="" src="{{ route("admin.article.getimg") }}/{{$obj->id}}&&date=<%date%>">
                                    </div>
								</div>
                                <div class="col-md-12">
									<div class="form-group">
										...
										<div class="form-check form-check-sm form-check-custom form-check-solid me-3">
											<input class="form-check-input" name="active" type="checkbox" data-kt-check="true" data-kt-check-target="#kt-datatable .form-check-input" value="1" checked={{$obj->active == 1?'checked':''}} />
