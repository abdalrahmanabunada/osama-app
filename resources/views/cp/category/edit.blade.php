			...
			<div class="col-lg-12">
				<div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
						<h3 class="card-title" style="font-weight:bold;">{{__('cat.info')}}</h3>
                        ...
                        <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										<label>{{__("cat.title")}}</label>
										<input type="text" id="title" name="title" value="{{$obj?$obj->title:''}}" class="form-control form-control-solid" placeholder="{{__("cat.enter").' '.__("cat.title")}}" autocomplete="off">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										<label style="clear: both; display: block;">{{__("cat.file")}}</label>
