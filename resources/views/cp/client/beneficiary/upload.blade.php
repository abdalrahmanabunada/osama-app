        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-info">
                            ...
                            <p>4-   يمكنك تحميل النموذج من <a href="{{route('client.beneficiary.upload.download')}}" target="_blank"><b><u>هنا</u></b> </a></p>
                        </div>
            </div>
        </div>
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
						<h3 class="card-title" style="font-weight:bold;">رفع بيانات المستفيدين</h3>
					...
					<form class="form ajaxForm" action="{{ route('client.beneficiary.upload') }}" name="PageController" id="PageController" method="post" ng-controller="PageController" enctype="multipart/form-data">
